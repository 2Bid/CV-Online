        ...
        <div className='cardSide__left'>
            ...
            <div className='social__container'>
                <div className='social__item'>
                    ...
                    <a className='social__link' href='https://www.linkedin.com/in/axel-salenbier-906130186/'>LinkedIn</a>
                </div>
                <div className='social__item'>
                    ...
                    <a className='social__link' href='https://github.com/2Bid'>Github</a>
                </div>
                <div className='social__item'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.25 32" width="20px" height="20px"><rect fill="#e3e5eb" x="1" y="1" width="45.25" height="30" rx="1"/><path fill="#e3e5eb" stroke="#232F3E" d="M46.25,2l-22,17.78a1,1,0,0,1-1.29,0L1,2"/><line stroke="#232F3E" x1="45.5" y1="31" x2="28.95" y2="16"/><line stroke="#232F3E" x1="2" y1="31" x2="18" y2="16.5"/></svg>
                ...
                <div className='social__item'>
                    ...
                    <a className='social__link' href='tel:+33769890782'>07 69 89 07 82</a>
                </div>
            </div>
