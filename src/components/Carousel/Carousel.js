...
export default function Carousel() {
  ...
  const projects = [
    ...
    <Project name="Kasa" link="https://2bid.github.io/AxelSalenbier_11_01042022/" img={Kasa} description={<p className='project__description'>- Intégration Application React</p>}/>,
    <Project name="SportSee" link="https://2bid.github.io/AxelSalenbier_12_24042022/" img={SportSee} description={<p className='project__description'>- Intégration Application React<br/>- Intéraction API<br/>- Documentation Js</p>}/>,
    ...
    <Project name="Datepicker input" link="https://2bid.github.io/AxelSalenbier_14_01112022/" img={datepicker} description={<p className='project__description'>- Création d'une librarie react<br/>- Conversion de Jquery à React<br/>- Analyse de performances</p>}/>,
    /* Projet Pers */ 
